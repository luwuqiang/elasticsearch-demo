...
package com.leederedu.elastic.smoketest;

import com.leederedu.elastic.ESClient;
...
public class SmokeTestClientIT extends ESClient {

    protected String index = "qa-smoke-test-client-";
